...
[![Michael Jackson - Thriller](Michael_Jackson_-_Thriller.png){fig-align="center" width="440"}](https://youtu.be/sOnqjkJTMaA?si=4UD7ISAeL2ntyW52)
...
![Correlation vs. Regression](corrreg.png){fig-align="center" width="534"}

## Why Does Correlation $\neq$ Causation?

-   [Here is a great website of spurious correlations](https://www.tylervigen.com/spurious-correlations)
...
[![T.I., Justin Timberlake - Dead And Gone](TI.jpeg){fig-align="center" width="526"}](https://www.youtube.com/watch?v=6mEx9FtuN0k)
...
[![Talking Heads - Life During Wartime (live)](pain_world.webp){fig-align="center" width="595"}](https://www.youtube.com/watch?v=8al5cSQNmME)
...
![Sum of squares example (from lecture) with candidate line](sum_of_squares_example.png){fig-align="center" width="767"}
...
[![LCD Soundsystem - Home](lcd.webp){fig-align="center"}](https://www.youtube.com/watch?v=ETDCbQUYiAQ)
...
*"for every one unit change in X, we observe a \_\_\_\_ change in Y.*

### Multivariate Regression:

"*for every one unit change in X, we observe a \_\_\_\_ change in Y, all else equal."*

### Multivariate regression with categorical IV interpretation:

"the expected change in Y for \[category X\] is \_\_\_\_, when compared to \[reference category\]."
...
![](https://lh7-rt.googleusercontent.com/slidesz/AGV_vUejOEX1b0sMew5iBRtdpyGGT-qulK0NjSRYTh8WG6nZmCKQfHh6RctsYAvemeJjVIcFIznql9a1jPMqxQXsTDP8aXza--kAOgs1GcAh75vs2SRKM3-zjk_2XKVHwhNBHdbwUYda=s2048?key=82bALnBoWx_XpS6iwiMlkCZu){width="323"}
...
[![Joy Orbison, Lil Yachty, Future, Playboi Carti - flex fm (freddit)](flexfm.jpeg){fig-align="center"}](https://www.youtube.com/watch?v=UZgiAu8QRAI)
...
[![Justice ft. Thundercat - The End](justice.webp){fig-align="center"}](https://www.youtube.com/watch?v=arulMUtTy_4)
...
![](teaching.qmd.gif){fig-align="center"}
