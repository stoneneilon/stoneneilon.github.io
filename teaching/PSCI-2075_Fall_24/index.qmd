...
y <- seq(10, 100, 5)
y
# note that you don't need to specific from, to, and by. The order is predetermined. Although it is good convention so you can better read what your code is doing. 
```
