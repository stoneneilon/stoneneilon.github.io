...
R is a programming language for statistics. It was first created in 1993. R is an object oriented environment. Many of you have had exposure to Excel and it's formulas. R is somewhat similar in that it gives us the same capabilities. However, R is much more powerful and can evaluate more data than Excel. Unfortunately, what we get in power, we trade off user experience.
