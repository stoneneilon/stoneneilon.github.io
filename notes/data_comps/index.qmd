...
*Logit gets criticized because it imposes the IIA -- independence of irrelevant alternatives. THIS IS BASICALLY ARROWS THEOREM OR SOMETHING LIKE IT. IF A \> B \> C, the addition of D should not influence the choices!*
...
**How do we know if we have overdispersion?** *We only care about conditional overdispersion, i.e., how much overdispersion is left over once we've modeled the conditional mean.* A casual (first-cut) test is simply to take the mean and variance of our DV and see how far apart they are. This is not terrible but is also not precise. It might be better to think over overdispersion as a form of specification error. Generally, conventional wisdom will just tell you to do both models and compare.

#### Poisson Issues

As discussed earlier, Poisson makes some assumptions and has some limitations. We need to have a good uinderstanding of the what issues may arise as this will help us navigate a more appropriuate model specification/fix. Some common departures from the standard Poisson regression are: (Cameron & Trivedi, 2014)

1.  **Failure of the mean-equals-variance restriction**
2.  **Truncation and censoring**
3.  **The "excess zeros" or "zero inflation" problem**
4.  **Multimodality**
5.  **Correlated observations**
6.  **Waiting times between event occurrences not exponential**
7.  **Trends**
8.  **Simultaneity and sample selection**
...
2.  For those that do, a subscriber may watch $y_i=0,1,2,…$
