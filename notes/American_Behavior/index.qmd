...
# Week 15: Representation (and Reflection)

-   Read Elements of Reason - cognition, choices, and the bonds of rationality

-   Achens & Bartels focus on groups

-   read of all Stimson

## Tides of Consent by James Stimson. Chapter 1, 3, 6

### Chapter 1:

-   Carter got destroyed by the Iranians and it helped Reagan

-   But alone cant be explained by the Iranians - Reagan was a conservative movement.

-   Why does public sentiment (on a large scale, not the day to day) ebb and flow over time? What starts them?

-   what moves the tides.

-   Is it a campaign story? Referenda of the incumbent story? Or is about what voters want in policy?

    -   these are all true but its a combination of all three.

-   Crisis change stuff

-   In three stories about opinion change,one thing is constant.In all three opinion moves. Important things happen in politics because opinion at one time is different than it was earlier.

    -   pace is different though.

-   This book is about all three dynamics. It is about how public opinion ebbs and flowsover time,what moves it,why it moves,and what we can understand about predicting and explaining those movements.

-   people are ignorant and calculating about politics

-   opinions where ephemeral

-   public is inconsistent with opinions

-   Some people some of the time pay attention to Government

-   Some people some of the time care what government does

-   Some of those who pay no attention to government will nonetheless form public opinion

-   Much public opinion is media influenced

-   Opinion is dominated by those who pay *some* attention

    -   why?

        -   aggregation gain

            -   central limit theorem vibe

            -   if some people become more conservative when government undertakes liberal actions and others respond randomly, the the public on average becomes more conservative.

            -   **The conclusion I have been building to is this: if just some people pay attention to politics and just some care a little bit about it, never mind all those who don't pay attention and don't care, the average of opinions will predominantly reflect those who pay attention and care.**

                -   this is what we observe in public opinion.

        -   opinion leadership

            -   all it takes is for some to care and the rest follows.

### Chapter 3: Left and Right Movements in Preference

-   abortion during Roe was not originally aligned with the parties.

-   chapter focuses on how controversy structure Americans' reactiosn to the parties and what happens when some new issue causes that number to expand.

    -   why and how do issues emerge, how they evolve, and how multiple facets of conflict come to be encapsulated in a two-sided struggle between the parties.

-   too many issues to focus on

    -   the elections constrains what is important - it is a bottleneck for policy choices.

-   think of voting as a 'bit'

-   Valence issues - these are really just assertions of support for values that are nearly universally held.

    -   these are different from "position" issues. Which are actually controversies.

-   How do issues evolve?

    -   Story 1 - Candidates:

    -   Story 2 - Voters:

        -   how do voters decided between candidates in a primary?

        -   path dependence

-   tax cuts were not a big thing before Reagan.

-   Goldwater moves the democratic south to the Republican party.

-   critical is the idea of a 'critical moment' - a catalyst

-   the story so far he is painting is savvy political candidates.

-   Central Question: What do Americans want government to do, and how do preferences change over time?

-   cycle of preferences.

-   Ideology: operational and symbolic

    -   We observe Americans prefer a government that does more rather than less - they are, that is, operationally liberal - when asked to describe their political identitiy, almost two of three choose the label conservative over the label liberal.

    -   Americans are symbolically conservative and operationally liberal.

        -   this is a puzzle.

-   Differences lie in how much and how fast to grow the government, not whether it should be larger or smaller

    -   yes but also im a bit unsure of this. I suppose in the aggregate yes.

-   Lots of symbolic conservatives that are operationally liberals

    -   this is considerably less vice versa.

    -   This is problematic - it means that candidates and parties that call themselves by that same label will in general be more appealing to them.

-   Republicans are good with symbols.

### Chapter 6:

-   Passionate \> The scorekeepers \> The Uninvolved

-   What moves the scorekeepers is critical.

-   We now have two ideas: that important political change occurs at the margin and that the citizens who produce it are a rare substratum of those who are dispassionate and still reasonably well informed.

-   Mood becomes more conservative under liberal governments,more liberal under conservative regimes.

    -   this requires some attentiveness of the citizenry.

    -   This would seem to call for more knowledge,more attentiveness to public affairs, than is typical of mass electorates.

        -   but not all need to be.

            -   If politics works at the margin, we can observe the aggregate responsiveness of mood if only some citizens are knowledgeable and attentive while others are either fixed in place or moving in response to a cacophony of false signals.

-   scorekeeprs care about outcomes.

    -   these are your nature of the time voters.

-   This book points to the conclusion that citizens - in the aggregate and at the margin - do succeed in communicating their preferences to government

    -   of course, these preferences are not steady and are suspetible to elite influence.

## Warshaw, C. 2019. "Local Elections and Representation in the United States." Annual Reviews of Political Science.
...
Partisanship exists in local elections.
...
-   local elections low turnout

-   conservative interests are more likely to win out in local elections and shrink the size of governemnt -

    -   i don't know if I agree with this.

-   voters can use party as a heuristic even in ostensibly nonpartisan races.

-   state and local elections have been fairly nationalized since at least the early 1990s.

-   Local governments do not really reflect hte demographic composition of their citizens.

-   there is difference in municipal spending changes in response to changes in prsidential voting patterns.

-   there are differences at the local level in voting patterns of city officials based off partisanship.

-   but there isnt much data on policy effect between partisanship at local level

## Persuasion in Parallel

### Chapter 1:

-   This chapter is Persuasion in Parallel in miniature. It explains the backlash prediction from the motivated reasoning literature and foreshadows how the empirical evidence for backlash rests on weak research designs. It introduces the persuasion in parallel hypothesis that the treatment effect of persuasive information on target attitudes is small, positive, and durable for everyone, taking care to distinguish between persuasive information and group cues. The chapter provides evidence from one survey experiment that Republicans and Democrats update their tax policy preferences in the same direction and by about the same amount in response to an op-ed in support of the flat tax. Lastly, the chapter connects the persuasion in parallel hypothesis to the classic parallel publics finding from the public opinion literature, contrasting the survey experiment and rolling cross-sectional survey research designs.

-   Motivated reasoning

    -   wanting to get it right

    -   wanting to arrive at a particular conclusion

-   Motivated reasoning is a result of **backlash**

    -   A key prediction of motivated reasoning theory is backlash: **exposure to counter-attitudinal evidence will cause people to hold more strongly to their preexisting positions.**

-   Book is going to try to push back a bit against motivated reasoning.

-   Persuasion occurs in parallel

    -   when people encounter new information, they don't distort it to further entrench their preexisting views---instead, they are persuaded in the direction of that information

-   argues that backlash isnt really a big thing.

-   this seems highly reliant on the stimulus given.

-   effect of persuasion decreases over time.

-   First and foremost: *the other side is persuadable*.

#### Chapter 5:

-   This chapter describes each survey experiment as a case study first, then meta-analyzes all the studies together. The chapter culminates in Figure 5.16, which provides strong evidence for the persuasion in parallel hypothesis by showing how strongly correlated the effects are across various subdivisions of society. If the effect is large and positive for Democrats, the effect for Republicans is likely to be large and positive as well; similar patterns hold for liberals and conservatives, White and Black Americans, men and women, younger and older Americans, and the better- and less-educated. The chapter also shows how the effect of exposure to two-sided messages is well-approximated by the sum of the effects of each message, which is to say they mostly cancel.
...
-   Persuasion in parallel means that people are heterogeneous in their political views but homogeneous in their responses to persuasive treatments.
