...
-   two parts: coordinates and attributes

    -   spatial and non-spatial part.
...
-   spaghetti models:
    ...
    -   editing and querying can be diffiicult

-   Topology: geometric properties that do not change with changing shapes (adjacency, connectivity, containment)

-   share boundaries = neighbors.

-   Euclidean vs network distance.

    -   distance means different things
