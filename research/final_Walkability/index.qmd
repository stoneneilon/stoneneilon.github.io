...
Given these potential mechanisms, we theorize the following:
...
While congressional primaries seem like a useful election type to study, we cannot account for the unique aspects of each congressional race. For example, some primaries were extremely close, while others ran uncontested. Coupled with the fact that states vary in who can vote in these primaries makes it extremely difficult to source a proper voter turnout count by Census block group for these elections. Additionally, we run into aggregation issues as Census block groups do not perfectly map onto congressional districts. While this is still an issue for the 2016 election, it is less so, as would be voters are likely to participate in this primary election because they are motivated to vote for their preferred presidential primary candidate. Finally, because President Obama was termed out, there is no concern for an incumbency advantage to cloud our results. The 2018 and 2020 elections are marked by Trump's presence in office and likely influence the level of turnout for primaries.
...
*Note: substantial revisions of this section will be completed after the survey.*
...
To our knowledge, this is the largest test of built environment factors on voter turnout in the United States. Our results add to the growing evidence between the built environment and political phenomenon.

While the internet has changed the way we communicate with others politically, we should not discount the role of face-to-face communication.

# Appendix

## Appendix A

### Spherical error checks: 
...
## Appendix Individual Level Results

Because the individual level voter file is so large, I restrict my individual level analysis to just the 2018 primary. My goal is to have all elections in the future. However, I am using a 3rd party data management hub that requires me to purchase computational credits to complete the full analysis. I am only allotted a certain amount of computation power to run these analysis and thus I can only do the 2018 primary at this time.

I selected the 2018 primary because I felt it would be the most substantively interesting.

### Individual Level Data

### Summary Statistics

## Appendix for QP Defense

-   This section is to help me remember the issue I am having with solving the sorting problem.
