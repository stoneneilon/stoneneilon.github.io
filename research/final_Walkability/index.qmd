...
Our independent variable is walkability. Walkability is defined as the ease of walking to amenities within an area [@forsyth2015walkable]. We use walkability to operationalize the built environment because it captures the layout of an area and mutes variation in architectural design. While previous research has found evidence between architectural features and voter turnout, we are only concerned about the built environment from an urban planning perspective [@levan2020neighborhoods]. This measurement decision is supported by previous work on the varying types of suburbia and political participation [@hopkins2012inactive].
...
### Treatment 2: Sociliaztion/Social Pressure:
