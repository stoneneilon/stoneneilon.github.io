---
title: "Do Environments Shape the Presence and Degree of Interpersonal Political Interactions?"
date: 2025-08-12
...
-    We theorized two types of environments that can shape interpersonal political interactions: \\textbf{demographic environments} and \\textbf{built environments}.

-   We find significant support for demographic environment effects on core and acquaintance network composition. But find null results for the built environment's influence at various model specifications. We presume this is due to measuring the built environment at the county level.

-   A greater supply of Republicans in a county, increases (decreases) Republican (Democrat) acquaintances.

-   While some research has proclaimed "the death of the local", we show that local environments still influence who and how people talk politics. However, we do not know the degree to which this has changed over time.
...
In addition, partisan index measure is at the county level. We intend to source a partisan segregation measure at the zip code level to better analyse the partisan demographic environment effect.
